    ...
    <div class="main-con">
      <div class="side-bar">
        ...
        <div class="profile-con">
          <a class="anchor ele" href="#"
            ><i class="fi fi-rr-bell ele noti"></i
          ></a>
          <a class="anchor" href="#"
            ><img
              class="profile_img"
      ...
      <div class="all-container">
        ...
        <div class="notification">
          <div class="notify">
            ...
            <div id="card1">
              <h2 class="header">Matches based on Birth-Chart</h2>
              <p class="para">
            ...
            <div id="card2" class="hidden">
              <h2 class="header">Location recommendation for dates</h2>
              <p class="para">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Est
                deleniti voluptatum non accusamus, sint repudiandae officia
                tempore quam expedita sit!
            ...
            <div id="card3" class="hidden">
              <h2 class="header">Daily Horoscope</h2>
              <p class="para">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Est
                deleniti voluptatum non accusamus, sint repudiandae officia
                tempore quam expedita sit!
